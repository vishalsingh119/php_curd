<?php
	...
	{
		$id = $_GET['edit_id'];
		$stmt_edit = $DB_con->prepare('SELECT userName, userProfession, userPic FROM team_users WHERE userID =:uid');
	...
	if(isset($_POST['btn_save_updates']))
	{
		...
		if(!isset($errMSG))
		{
			$stmt = $DB_con->prepare('UPDATE team_users 
									     SET userName=:uname, 
										     userProfession=:ujob, 
										     userPic=:upic 
								       WHERE userID=:uid');
			...
			if($stmt->execute()){
				...
				window.location.href='../blog/admin/team.php';
...
<div class="container">
	...
	<div class="page-header">
    	<h1 class="h2">update profile. <a class="btn btn-default" href="../blog/admin/team.php"> all members </a></h1>
    </div>
